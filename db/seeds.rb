...
DesiSaysModal.create(module: 'future',  slug: "family_phone",                        content: "I need your cellphone number to make it easy for you to log in and for me to save your work and keep your information safe. It must be a ten-digit mobile telephone number like (917) 555-1212, where I can send you texts. Please see our <a href='http://www.decisionfish.com/privacy-policy' target='_blank'>Privacy Policy</a> and <a href='http://www.decisionfish.com/security-policy' target='_blank'>Security Policy</a>.")
...
DesiSaysModal.create(module: 'future',  slug: 'future_history_heirs',                content: "A good retirement plan will make sure you have enough money to last your entire lifetime. To be safer, I assume you'll live about ten years longer than the average. You can set up a will to leave any leftover money to family, friends, chartities etc.")
...
DesiSaysModal.create(module: 'budget',  slug: "budget_expenses",                     content: "No need to be exact here. Tell me what you've been spending in each category. Next, I'll show you the relationship between your spending and your needs.")
DesiSaysModal.create(module: 'import',  slug: "import",                              content: "We trust MX to import your financial data aggregation from institutions. You can find their security policies and practices on their website at <a href='https://www.mx.com/resources/2015/7/21/security-at-mx-how-we-protect-your-data' target='_blank'>How we protect your data</a>. Decision Fish does not store your bank credentials, but relies on MX and their industry-leading security precautions.")
DesiSaysModal.create(module: 'global',  slug: "welcome_back_dashboard",              content: "See how you much you’re spending, saving and improving your financial wellness.")
DesiSaysModal.create(module: 'global',  slug: "welcome_back_savings",                content: "Time to pay credit cards, loans and make investments? Decide where to best put your savings to work this month.")
DesiSaysModal.create(module: 'global',  slug: "welcome_back_ideas",                  content: "Give or get a good idea for saving or spending money.")
DesiSaysModal.create(module: 'global',  slug: "welcome_back_ask",                    content: "Drop me a line if you want help with a specific decision, have a suggestion, or a good fish joke!")
DesiSaysModal.create(module: 'global',  slug: "welcome_back_revisit",                content: "Review or change your retirement, budget or savings plans.")
DesiSaysModal.create(module: 'global',  slug: "dashboard_control",                   content: "How well are you keeping to the spending plan that we made in the BUDGET chapter? It's OK if you go over in some categories as long as you spend less in others, so you remain on track to meet your saving goal.")
DesiSaysModal.create(module: 'global',  slug: "dashboard_security",                  content: "This measures the number of months of expenses you can meet using cash that you’ve saved for emergencies. An emergency fund can help you bounce back from job, health and other setbacks as well as take advantage of opportunities. You'll feel less stress because it will help you even out low-income or high-expense months and save on fees and interest.")
DesiSaysModal.create(module: 'global',  slug: "dashboard_freedom",                   content: "You designed a Happy Budget® to increase your happiness by aligning your spending with your needs. Are you spending money wisely to address unmet needs?")
DesiSaysModal.create(module: 'global',  slug: "dashboard_confidence",                content: "Grow your net worth (cash and investments minus debt) to meet long-term goals like retirement, education…even a new aquarium!")
DesiSaysModal.create(module: 'global',  slug: "dashboard_next_visit",                content: "I'll send you a gentle reminder email to come back to continue with me on our path to financial wellness together!")
